...
public class ApplicationContextExtendsFindTest {
    ...
    public void findBeanBySubType() {
        RateDiscountPolicy bean = ac.getBean(RateDiscountPolicy.class);  // 구체적
    ...
    static class TestConfig {
        ...
        @Bean
        public DiscountPolicy rateDiscountPolicy() {  // DiscountPolicy로 하는 이유 -> 역할과 구현을 쪼개야 해서 (역할을 한 눈에 알아볼 수 있도록)
